...
namespace Bose.Wearable
{
	...
	/// </summary>
	public sealed class DataMetrics : MonoBehaviour
	{
		/// <summary>
		...
		/// <summary>
		/// The most recent delta time received from the provider, or null if no data has been received
		/// </summary>
		public float? LastDeltaTime
		{
			get { return _lastDeltaTime; }
		}
		...
		private void UpdateSensorStats()
		{
			...
			if (_lastTransferSize > 0)
			{
				...
				_lastDeltaTime = _wearableControl.CurrentSensorFrames[_lastTransferSize - 1].deltaTime;
